...
export default new Command({
  ...
  async execute(_, message) {
    ...
    if (!user)
      return message.channel.send(embed({ description: "Seems like this user has not earned any xp so far" }, message)); // If there isnt such user in the database, we send a message in general.
